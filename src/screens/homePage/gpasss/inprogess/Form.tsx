...
function Form() {
  const [data, setData] = useState(
    JSON.parse(localStorage.getItem("selected2") || "")
  );
        ...
        <div className=" rounded-md relative animate__animated animate__fadeInUp mt-5 mb-20  w-[80%] sm:w-full sm:mx-5 max-w-[1366px] sm:px-2 px-10 border-dashed border border-blue/50 bg-white min-h-[200px] pb-5">
          <div className=" w-full flex items-center justify-between py-4 ">
            <div className=" flex flex-col leading-2">
              <h1 className=" font-semibold text-base sm:text-xs">
                {editable ? "Editable File Details" : "Received File Details"}
              </h1>
              {editable ? (
                <p className=" text-xs text-red-600 font-medium sm:text-[8px]">
                  *Note that once you click save it will update you document
                  details
                </p>
              ) : (
                <p className=" text-xs font-medium sm:text-[8px]">
                  Don’t forget to leave remarks of the before clicking Received
                </p>
              )}
            </div>
          ...
          <form
            className=" w-full border border-gray-500/20 rounded-[5px] px-5 py-8  grid grid-cols-4 gap-3  sm:grid-cols-1    "
          ...
          >
            ...
            <InputTemp
              label="Venue"
              placeholder="E.g N Hotel, Cagayan de Oro Mis. Or"
            ...
            <InputTemp
              ...
              placeholder="E.g Taylor Sheeesh"
              span="col-span-2 sm:col-span-1"
              disabled={!editable}
            ...
            <Button
              variant="outline"
              className=" bg-[#038500] rounded-[5px] text-white col-span-4 sm:col-span-1"
            >
